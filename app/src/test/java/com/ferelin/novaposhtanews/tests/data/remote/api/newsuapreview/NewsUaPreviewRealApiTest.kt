...
internal class NewsUaPreviewRealApiTest : KoinBaseTest() {
    ...
    @Test
    fun `real request to fetch first news item should be success`() = runTest {
        val result = newsUaPreviewApi.fetchFirst()
        assertTrue { result.isSuccess }
    }

    @Test
    fun `real request to fetch news page should be success`() = runTest {
